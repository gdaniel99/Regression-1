...
#before the tilde is the output (y) and after is the input/predictor (x)
summary(reg1)
#must run summary code to get output
```
...
#use "text" instead of "html" to get and actual output in R. "html" only gives formatted outcome in a webpage
# compare the results of the two regression models
